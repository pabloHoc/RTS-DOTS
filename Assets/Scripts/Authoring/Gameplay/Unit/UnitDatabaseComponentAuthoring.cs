...
namespace RTS.Authoring.Gameplay.Unit
{
    ...
    public class UnitDatabaseComponentAuthoring : MonoBehaviour
    {
        public UnitsData UnitsData;

        public class UnitDatabaseBaker : Baker<UnitDatabaseComponentAuthoring>
        {
            public override void Bake(UnitDatabaseComponentAuthoring componentAuthoring)
            {
                var entity = GetEntity(TransformUsageFlags.None);
                
                var blobReference = BlobAssetUtils.BuildBlobAsset(componentAuthoring.UnitsData, 
